...
export function RequestDetail({
  ...
  const cDate = typeof c.date === "string" && c.date
        ...
        <div>
          <div style={{ background: "white", borderRadius: 20, padding: 24, border: "1.5px solid #EDE0C4", marginBottom: 16 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              ...
              {cComment && <div style={{ gridColumn: "1/-1" }}><span className="lbl">Commentaire</span><div style={{ fontSize: 14, color: MUTED, lineHeight: 1.6, marginTop: 4 }}>{cComment}</div></div>}
            </div>
          </div>
